...
# def boundary_fill(image, x, y, boundary_color, fill_color):
#     if x < 0 or x >= len(image[0]) or y < 0 or y >= len(image) or image[y][x] == boundary_color or image[y][x] == fill_color:
#         return
#     image[y][x] = fill_color
#     boundary_fill(image, x + 1, y, boundary_color, fill_color)
#     boundary_fill(image, x - 1, y, boundary_color, fill_color)
#     boundary_fill(image, x, y + 1, boundary_color, fill_color)
#     boundary_fill(image, x, y - 1, boundary_color, fill_color)
...
# def flood_fill(image, x, y, old_color, new_color):
#     if x < 0 or x >= len(image[0]) or y < 0 or y >= len(image) or image[y][x] != old_color:
#         return
#     image[y][x] = new_color
#     flood_fill(image, x + 1, y, old_color, new_color)
#     flood_fill(image, x - 1, y, old_color, new_color)
...
#                     print("Starting point is outside the grid boundaries. Please enter a valid starting point.")
#                 else:
#                     break
#             except ValueError:
#                 print("Invalid input. Please enter integers for x and y coordinates.")
